...
import MyPdf from '../assets/img/resume-example.pdf'
...
export const Banner = () => {
  ...
  const toRotate = [ "Python", "SQL", "ML", 'DL', 'Pandas', 'Numpy', 'PowerBi','Tableau','Rasa','Big Data','NLP', 'CV' ];
  const period = 2000;
            ...
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1><span className="txt-rotate" dataPeriod="1000" ><span className="wrap">' {text} '</span></span></h1>
                  ...
                  <button ><a href="#connect">Hire Me Now!<ArrowRightCircle size={25} /></a></button>
